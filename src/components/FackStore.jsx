...
export function FackStore(){
    ...
    return(
        <div className="container-fluid">
            <header className="border border-1 p-2 d-flex justify-content-between">
            <h2>FackStore</h2>
            <div>
                <div className="input-group">
                    <input type="text" className="form-control" placeholder="search FackStore.com"/>
            ...
            <section className="mt-3 row">
                ...
                <main className="col-10 d-flex flex-wrap overflow-auto"style={{height:'500px'}} >
                    {
                        products.map(product=><div key={product.id} className="card m-2 p-2" style={{width:'200px'}}>
                            <img src={product.image} className="card-img-top" height="120"/>
                            <div className="card-header" style={{height:'120px'}}>{product.title}</div>
                            <div>
                                <dl> 
                                    <dt>price</dt>
                                    <dd>{product.price}</dd>
